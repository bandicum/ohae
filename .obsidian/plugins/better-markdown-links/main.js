...
var require_RenameDeleteHandler = __commonJS({
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/RenameDeleteHandler.cjs"(exports2, module2) {
    ...
    function registerRenameDeleteHandlers2(plugin, settingsBuilder) {
      ...
      plugin.registerEvent(
        app.vault.on("delete", (file) => {
          ...
          (0, import_ChainedPromise3.chain)(app, () => handleDelete(app, path));
        })
      );
      plugin.registerEvent(
    ...
    function handleRename(app, oldPath, newPath) {
      ...
      (0, import_ChainedPromise3.chain)(app, () => handleRenameAsync(app, oldPath, newPath, backlinks));
    }
    async function handleRenameAsync(app, oldPath, newPath, backlinks) {
      ...
      try {
        ...
        (0, import_ChainedPromise3.chain)(app, () => {
...
function convertLinksInCurrentFile(plugin, checking) {
  ...
  if (!checking) {
    (0, import_ChainedPromise.chain)(plugin.app, () => convertLinksInFile(plugin, activeFile));
  }
  return true;
}
